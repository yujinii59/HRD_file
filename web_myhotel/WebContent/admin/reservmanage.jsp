...
<table style="width: 70%; margin-left: auto; margin-right: auto;  font-size: 15px;">
	...
	<%
	ArrayList<ReserveDto> list = reserveMgr.getReserveAll();
	...
	<tr style="text-align: center;">
		...
		<td><a href = "javascript:reservDetail('<%=reserv.getNo() %>')">상세보기</a></td>
	</tr>
	<%	
		}
	}
...
<form action="reservedetail.jsp" name="reservedetailFrm">

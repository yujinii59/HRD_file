		...
		<td>
			...
			<table style="margin-left: auto; margin-right: auto;">
				...
				<tr>
					...
					<input type="button" value = "확인" onclick="javascript:reserveCheck()">
					<input type = "button" value = "수정" onclick = "javascript:reserveUp('<%=dto.getNo() %>')">
					<input type = "button" value = "삭제" onclick = "javascript:reserveDel('<%=dto.getNo() %>')">
					</td>
				</tr>
			</table>
			</form>
...
<form action="reservedel.jsp" name="reservedelFrm">
<input type="hidden" name="no">
</form>
<form action="reserveup.jsp" name="reserveupFrm">
<input type="hidden" name="no">
</form>
</body>
</html>